        ...
        <div class="container vertical-center">
            <div class="row fix-height">
                <div class="col-xs-7 vertical-center">
                        {include file="snippets/editor.tpl" code="index-old" dark=true}
                        <div class="parallax" data-distance="250" data-direction="top" data-lag="1.5" data-offset="350" data-fade="3.5" data-minus="false">
