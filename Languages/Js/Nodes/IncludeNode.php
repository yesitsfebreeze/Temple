 ...
 * Class ExtendNode
 *
 * @package Temple\Languages\Js\Nodes
 */
class IncludeNode extends Node
{
    ...
    {
        $includeFile = $this->Engine->Template()->process($this->includeFile);
        $this->Engine->Cache()->addDependency($this->getNamespace(), $this->includeFile);
